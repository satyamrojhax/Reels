    ...
    <div className="mx-auto max-w-[1200px] px-6 py-10">
      <div className="mb-8">
        ...
        <h1 className="mt-2 font-display text-[48px] leading-[1.05] lowercase text-cocoa md:text-[64px] dark:text-cream">
          saved reels <span className="text-marker">({items.length})</span>
        </h1>
      </div>

      {items.length === 0 ? (
        <div className="paper-card flex flex-col items-center justify-center py-20 text-center">
          <Bookmark className="h-14 w-14 text-marker" strokeWidth={1.75} />
          <h2 className="mt-4 font-display text-2xl lowercase">nothing saved yet</h2>
          <p className="mt-2 max-w-sm text-sm text-charcoal/70 dark:text-cream/70">
            tap the bookmark on any reel and it lands here — like a bookmark in your favorite book.
          </p>
