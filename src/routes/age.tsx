  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-cream px-6 py-10">
      ...
      <div className="relative w-full max-w-lg">
        <p className="mb-3 font-display text-marker text-xl lowercase italic">dear grownups,</p>
        <h1 className="font-display text-[56px] leading-[1.05] lowercase text-cocoa md:text-[72px]">
          are you <span className="marker-underline">eighteen</span> or older?
        </h1>
        <p className="mt-5 max-w-md text-[17px] leading-relaxed text-charcoal/80">
        ...
        <p className="mt-6 text-sm text-charcoal/60">no signup, no tracking. everything lives on this device.</p>
      </div>
    </div>
  );
}
