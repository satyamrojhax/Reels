...
function AgePage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-6 py-10">
      <Sticker
        className="left-6 top-8 rotate-[-12deg]"
        color="var(--color-sky-sticker)"
        shape="bolt"
      />
      <Sticker
        className="right-10 top-20 rotate-[8deg]"
        color="var(--color-bubblegum-sticker)"
        shape="heart"
      />
      <Sticker
        className="bottom-14 left-12 rotate-[10deg]"
        color="var(--color-sprout-sticker)"
        shape="star"
      />

      <div className="relative w-full max-w-lg">
        <p className="mb-3 font-display text-destructive text-xl lowercase italic">
          dear grownups,
        </p>
        ...
        <p className="mt-5 max-w-md text-[17px] leading-relaxed text-foreground/80">
          this playground is stitched together from adult reels. pinky-promise you're 18+ and we'll
          let you in.
        </p>
