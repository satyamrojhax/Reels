      ...
      <section className="mt-8 space-y-6">
        <div className="paper-card p-6">
          ...
          <p className="mt-3 text-sm text-charcoal/70 dark:text-cream/70 leading-relaxed">
            Reels is your ultimate destination for watching premium 18+ video content. We provide a
            seamless, ad-free experience with a curated collection of high-quality reels from
            various sources. Our platform is designed to be fast, responsive, and easy to use,
        ...
        <div className="paper-card p-6">
          ...
          <p className="mt-3 text-sm text-charcoal/70 dark:text-cream/70 leading-relaxed">
            Your privacy is our top priority. All your data including liked reels, saved reels, and
            personal information is stored locally on your device. We don't collect or store any
            personal data on our servers. Your PIN and preferences are encrypted and stored securely
        ...
        <div className="paper-card p-6">
          ...
          <p className="mt-3 text-sm text-charcoal/70 dark:text-cream/70 leading-relaxed">
            ...
            <span className="font-semibold text-marker">Satyam RojhaX</span>. Built with modern web
            technologies including React, TypeScript, and Tailwind CSS to provide the best possible
            user experience.
          </p>
