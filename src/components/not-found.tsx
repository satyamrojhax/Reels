...
export function NotFoundComponent() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-dusk-indigo px-4 text-center">
      ...
      <h2 className="mt-4 text-2xl font-semibold tracking-tight text-white/90">Not Found</h2>
      <p className="mt-4 max-w-sm text-sm leading-relaxed text-white/60">
        We couldn't find the page you're looking for. It might have been removed, renamed, or didn't
